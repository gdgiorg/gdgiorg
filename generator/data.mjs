...
export const people = [
  ...
  { slug: 'dr-sunny-akpoyibo', name: 'Dr. Sunny Akpoyibo', role: 'Member, Board of Trustees', group: 'trustee',
    ...
    bio: [
      ...
      'His multifaceted experience in business management, renewable energy, and philanthropy makes him a pivotal Trustee for GDGI, bringing a wealth of knowledge and a proven track record in fostering inclusive and sustainable development.',
    ] },
  { slug: 'chief-dr-anita-nana-okuribido', name: 'Chief Dr. Anita Nana Okuribido', role: 'Secretary, Board of Trustees', group: 'trustee',
    ...
    bio: [
      ...
      'Throughout her distinguished career, Anita has been a driving force for sustainable development, advocating for women’s empowerment and the adoption of renewable energy solutions. Her leadership, characterized by a deep commitment to inclusivity and environmental stewardship, continues to inspire and catalyze a movement towards a more sustainable, equitable, and green future.',
    ] },
  { slug: 'zainab-yusuf', name: 'Zainab Yusuf', role: 'Member, Board of Trustees', group: 'trustee',
    photo: 'assets/photos/zainab-yusuf.jpg',
    bio: ['Zainab Yusuf is a trailblazing advocate for disability inclusion and a proud alumna of Library and Information Science. Driven by her unshakeable faith and passion for humanity, she champions accessibility and equality for persons with disabilities. As a person with albinism, Zainab embodies resilience and determination, inspiring others with her remarkable leadership and unwavering commitment to creating a more inclusive world.'] },
  ...
  { slug: 'adama-ojochogwu-innocent-esq', name: 'Adama, Ojochogwu Innocent, Esq.', role: 'Member, Board of Trustees', group: 'trustee',
    ...
    bio: [
      'Adama, Ojochogwu Innocent, Esq. graduated from the prestigious Ahmadu Bello University (ABU), Zaria, Nigeria, before proceeding to the Nigerian Law School, Lagos Campus, and being called to the Nigerian Bar as a Barrister and Solicitor of the Supreme Court of Nigeria after a successful Bar Final Examination.',
      'He has been in active legal practice since his call to the Bar, with a keen eye for the details others would ignore across a wide range of litigation and legal practice. He is the Principal Counsel of I.O. Adama & Co. Grace Chambers, a law firm registered with the Nigerian Corporate Affairs Commission (CAC) in 2015 and headquartered in Abuja. He is presently Company Secretary and Director of Legal at Castlerock Econetwork Africa Ltd.',
      'He holds an LL.M from the University of Abuja, a B.L from the Nigerian Law School, Lagos, and both an LL.B and a Diploma in Law from Ahmadu Bello University, Zaria.',
      'His practice areas span environmental law, corporate law, property law, cybercrimes and new technologies, intellectual property, telecommunications, oil and gas, maritime law, human rights, arbitration, mediation and conciliation, and dispute resolution.',
      'He is a member of the Nigerian Bar Association (NBA) and the Association of Environmental Lawyers of Nigeria (AELN).',
    ] },
  { slug: 'echiche-kenneth-adinya', name: 'Echiche Kenneth Adinya', role: 'Member, Board of Trustees', group: 'trustee',
    photo: 'assets/photos/echiche-kenneth-adinya.jpg',
    bio: [
      'Kenneth Adinya Echiche is a visually impaired disability inclusion advocate with a two-time tenure as chairman of persons with disabilities in Cross River State. He is a Mass Communication graduate of the University of Jos, Nigeria, and a former presenter with CRBC Radio in Cross River State.',
